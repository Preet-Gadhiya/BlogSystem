...
public class ObjectFactory {
    ...
    private final static QName _MyBlogPassword_QNAME = new QName("http://schemas.datacontract.org/2004/07/WcfBlogServiceLibrary", "password");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/WcfBlogServiceLibrary", name = "password", scope = MyBlog.class)
    public JAXBElement<String> createMyBlogPassword(String value) {
        return new JAXBElement<String>(_MyBlogPassword_QNAME, String.class, MyBlog.class, value);
    }
